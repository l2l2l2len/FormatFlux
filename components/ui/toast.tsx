        ...
        {toasts.map((toast) => (
          <div
            ...
            className={cn(
              ...
              toast.type === 'info' && "border-accent-indigo/30 text-ink dark:text-text-primary"
            )}
          >
            ...
            <button
              ...
              className="hover:bg-ink/10 dark:hover:bg-white/10 p-1 rounded-full transition-colors text-slate dark:text-text-muted hover:text-ink dark:hover:text-text-primary"
            >
              <X size={16} />
            </button>
          </div>
